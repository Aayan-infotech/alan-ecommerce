  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route
          path="/guide/accurate-window-measurements"
          element={<AccurateWindowMeasurements />}
        />
        <Route
          path="/guide/accurate-door-measurements"
          element={<AccurateDoorMeasurements />}
        />
        ...
        <Route
          path="/guide/approvedInstallerDoorWindow"
          element={<ApprovedInstallerDoorWindow />}
        />
        ...
        <Route
          path="/guide/question-installer"
          element={<QuestionInstaller />}
        />
        ...
        <Route
          ...
          element={<ReplacementWindows />}
        />
        <Route path="/diy/skin-door" element={<SkinDoor />} />
        <Route
          path="/diy/replace-inset-window"
          element={<WindwoflushWithWall />}
        />
