...
import { clearCart, deleteProduct, fetchAllProducts } from "../redux/slices/addToCartSlice";
...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (searchRef.current && !searchRef.current.contains(event.target)) {
        ...
        setShowSearch(false); // Hide search box if needed
      }
    };
  ...
  return (
    <div style={{ paddingLeft: "23px", paddingRight: "23px" }}>
      <AppBar
        position="sticky"
        color="default"
        className="navbar-content rounded-3"
        sx={{
          margin: { xs: "0", sm: "10px auto", md: "15px auto", lg: "20px auto 0" },
          padding: { xs: "8px", sm: "10px", md: "12px", lg: "6px" },
          width: "100%",
          top: 0,
          zIndex: 999,
        }}
          ...
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            {!isMobile && (
              <>
                ...
                <Box sx={{ display: "flex", alignItems: "center" }} className="me-2" ref={searchRef}>
                  {showSearch && (
                    <TextField
                      variant="outlined"
                      placeholder="Search...."
